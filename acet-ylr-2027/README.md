...
Up to **USD 15,000** over 12 months, with mentorship from ACET Senior Fellows, peer networking, and support to present and publish.
...
- [ ] African national, or resident based in Africa
- [ ] 35 or younger as of 1 January 2027
- [ ] Hold or currently enrolled in a Master's degree or higher
- [ ] Academic background in economics or a related analytical field
...
1. **Confirm the sampling frame.** The design depends on access to programme or distributor client lists. A named, secured partner materially strengthens the note; if you secure one, add it to the Setting and data section.
